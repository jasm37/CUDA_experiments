...
int main(int argc, char **argv)
{
   ...
   ///////////////////////////////////
    ...
    //set_edge_colors(float *colors, float *t1, float *t2, float *t3, float dimx, float dimy,float alpha, float beta)
    float alpha = 0.01, beta = 0.001;
    ...
    */
    CUDA_CHECK;
    //cudaMemcpy( imgOut, colors, nbytes, cudaMemcpyDeviceToHost );CUDA_CHECK;
